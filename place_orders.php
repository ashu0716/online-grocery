              ...
              <table class="table table-bordered table-invoice-full">
                <tbody>
                  <tr >
                    ...
                    Payment method : &nbsp;&nbsp;&nbsp;&nbsp;<a href=" " class="tip-bottom" title="Online Payment" style="color:#F00;">Online Payment</a> </h4>
                     </td>
                    <td class="right"   style="color:#FFF;"><strong>Subtotal</strong></td>
                    <td class="right"  style="color:#FFF;"><strong>₹&nbsp; <?php  echo $sub_total; ?></td>
                  </tr>
                </tbody>
              </table>
              <div class="pull-right"  style="margin-bottom:20px; border:0px solid red; width:100%; ">
                <h3 style="border:0px solid red; width:100%; ">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                <span style="border:0px solid red; ">
                Grand Total : &nbsp;&nbsp;&nbsp;
                </span>
                ₹&nbsp; <?php  echo $grand_total_order=$sub_total; ?>&nbsp;&nbsp;</h3>
                <br>
				...
				if($discount_total > 0)
				{
				echo "<span class='blink_me' style='border:0px solid red; color:#CFF; '>
                You Saved : &nbsp;&nbsp;&nbsp;
                </span><span class='blink_me' style='border:0px solid red; color:#CFF; '>₹&nbsp; $discount_total &nbsp;&nbsp;</span></h4><br>";
                }
                else
				{
					echo "";
            ...
            <button type="submit" name="place_order" id="place_order" class="btn btn-primary btn-large pull-right" style="background-color:#FF0000; border:none; width:150px; height:48px; font-size:18px;">
            <i class="fa fa-check-circle">&nbsp;<a href="payment.php">Place Order</a></i> 
            </button>                 
			</p>
