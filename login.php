      ...
      <div class="w3_login_module" >
        <div class="module form-module" >
          ...
          <div class="form"  >
            ...
            <form action="" method="post" >
             <p  style="width:100%; border: 0px solid #CC3333;color: red !important;">Username is required.</p>
             <input type="text" name="uname_reg" id="uname_reg" placeholder="Username" >
              
              <p  style="width:100%; border: 0px solid #CC3333;color: red !important;">@-mail is required.</p>
             <input type="email" name="email_reg" placeholder="Email Address" >
              <input type="password" name="pass_reg" placeholder="Password" >
              <input type="text" name="mob_reg" placeholder="Mobile Number"  maxlength="10" >
            ...
            $status=$_POST['status'];
					 ...
					 $select_reg_email="select * from client where clint_email='$email_reg'";
					 $query_reg_email=mysql_query($select_reg_email)or die(mysql_error());
					 $num_reg_email=mysql_num_rows($query_reg_email);
					  if($num_reg_email>0)
					  {
					  ...
					  $query_reg=mysql_query($insert_reg)or die(mysql_error());
