...
<div class="col-sm-4 col-md-3 m-b-3">
          ...
          <ul class="nav nav-pills nav-stacked">
           <li id="account-profile" ><a href="account-profiles.php">My Profile</a></li>
            <li id="account-address"  class="active-account"><a href="account-addresss.php">My Address</a></li>
            <li id="account-password" ><a href="account-passwords.php">Change Password</a></li>
          </ul>
        </div>
        <!-- End Account Sidebar -->
        ...
        <div class="col-sm-8 col-md-9">
          <div class="title m-b-2" style="margin-bottom:20px; font-size:20px; font-weight:500;"><span style="color:#00F; font-size:22px;">Editing My Address</span></div>
          <div class="row">
            <div class="col-xs-12">
              <ul class="list-group list-group-nav">
              <form name="billing" method="post" action="">
                <?php
              $select_billing_address="select * from billing_address where clint_id='$clint' ";
			  $query_billing_address=mysqli_query($conn, $select_billing_address)or die(mysqli_error($conn));
			  $row_billing_address=mysqli_num_rows($query_billing_address);
			  
			  $fetch_billing_address=mysqli_fetch_array($query_billing_address);
			  
			  $fullname=$fetch_billing_address['bill_flname'];
			  $address=$fetch_billing_address['bill_add'];
			  $city=$fetch_billing_address['bill_city'];
			  $pincode=$fetch_billing_address['bill_pincode'];
			  ?>
              
                <li class="list-group-item">
                  <strong >Full Name</strong>
                  <p><input name="fullname_bill" id="fullname_bill" style="width: 100%;    border: 1px solid #d9d9d9;  margin-top:7px;    padding: 7px 7px;   font-weight:500;  
                   font-size: 14px; color:#F00; background-color:transparent; " type="text" value=" <?php echo $fullname; ?>"></p>
                </li>
                <li class="list-group-item">
                  <strong >Address</strong>
                  <p><textarea name="address_bill" id="address_bill" style="width: 100%; height:38px;    border: 1px solid #d9d9d9;  margin-top:7px; padding: 7px 7px;   font-weight:500;  
                   font-size: 14px; color:#F00; background-color:transparent; "  > <?php echo $address; ?> </textarea></p>
                </li>
                
                <li class="list-group-item">
                  <strong >City</strong>
                  <p><input name="city_bill" id="city_bill" style="width: 100%;    border: 1px solid #d9d9d9;  margin-top:7px;    padding: 7px 7px;   font-weight:500;  
                   font-size: 14px; color:#F00; background-color:transparent; "  type="text" value=" <?php echo $city; ?>"></p>
                </li>
                <li class="list-group-item">
                  <strong >Post Code</strong>
                  <p><input name="pincode_bill" id="pincode_bill" style="width: 100%;    border: 1px solid #d9d9d9;  margin-top:7px;    padding: 7px 7px;   font-weight:500;  
                   font-size: 14px; color:#F00; background-color:transparent; " type="text" maxlength="6" value=" <?php echo $pincode; ?>"></p>
                </li>
                <style>
             	#edit-account:hover 		
				{
			...
			border:none;
              ...
              <button type="submit" name="update_billing"  id="edit-account" class="btn btn-success pull-right">
              <i class="fa fa-pencil"></i> &nbsp;Edit My Address
              </button>
              <?php
			  if(isset($_POST['update_billing']))
			  {
				  ...
				  $pincode_bill=$_POST['pincode_bill'];
				  if($row_billing_address > 0)
				  {
				  $update_bill_update="update billing_address set bill_flname='$fullname_bill',bill_add='$address_bill',bill_city='$city_bill',bill_pincode='$pincode_bill' where clint_id='$clint' ";
				  $query_bill_update=mysqli_query($conn, $update_bill_update)or die(mysqli_error($conn));
				  header("location:account-addresss.php");
				  }
				  else
				  {
				  $insert_bill_insert="insert into billing_address values ('','$clint','$fullname_bill','$address_bill','$city_bill','$pincode_bill' ) ";
				  $query_bill_insert=mysqli_query($conn, $insert_bill_insert)or die(mysqli_error($conn));
				  header("location:account-addresss.php");
				  }
			  }
                ?>
