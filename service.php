    ...
    <div class="services">
      ...
      <div class="w3ls_service_grids">
        <div class="col-md-5 w3ls_service_grid_left">
          ...
          <p>Customers can browse and purchase items through the store's website.</p>
        </div>
        <div class="col-md-7 w3ls_service_grid_right">
          <div class="col-md-4 w3ls_service_grid_right_1"> <img src="images/18.jpg" alt=" " class="img-responsive"> </div>
          <div class="col-md-4 w3ls_service_grid_right_1"> <img src="images/19.jpg" alt=" " class="img-responsive"> </div>
          <div class="col-md-4 w3ls_service_grid_right_1"> <img src="images/20.jpg" alt=" " class="img-responsive"> </div>
          <div class="clearfix"> </div>
        </div>
        <div class="clearfix"> </div>
      </div>
      ...
      <div class="w3ls_service_grids1">
        <div class="col-md-6 w3ls_service_grids1_left"> <img src="images/4.jpg" alt=" " class="img-responsive"> </div>
        <div class="col-md-6 w3ls_service_grids1_right">
          <ul>
            <li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Delivery: Groceries can be delivered to the customer's doorstep at a time and date that is convenient for them.</li>
            <li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Click and Collect: Customers can place their order online and then pick it up at a designated location.</li>
            <li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Subscription Services: Customers can set up recurring deliveries for frequently purchased items.</li>
            <li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Discounts and Coupons: Online grocery stores may offer discounts and coupons to help customers save money on their purchases.</li>
            <li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Product Reviews and Recommendations: Customers can view product reviews and recommendations to help them make informed purchasing decisions.</li>
            <li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Customer Support: Online grocery stores typically offer customer support through email, phone, or live chat to help customers with any questions or concerns.</li>
          </ul>
          <a href="all_product.php">Shop Now</a> </div>
        <div class="clearfix"> </div>
      </div>
    </div>
    <!-- //services --> 
...
<div class="services-bottom">
  <div class="container">
    <div class="col-md-3 about_counter_left"> <i class="glyphicon glyphicon-user" aria-hidden="true"></i>
      <p class="counter">89,147</p>
      <h3>Followers</h3>
    </div>
    <div class="col-md-3 about_counter_left"> <i class="glyphicon glyphicon-piggy-bank" aria-hidden="true"></i>
      <p class="counter">54,598</p>
      <h3>Savings</h3>
    </div>
    <div class="col-md-3 about_counter_left"> <i class="glyphicon glyphicon-export" aria-hidden="true"></i>
      <p class="counter">83,983</p>
      <h3>Support</h3>
    </div>
    <div class="col-md-3 about_counter_left"> <i class="glyphicon glyphicon-bullhorn" aria-hidden="true"></i>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"26612e640c","applicationID":"3365418","transactionName":"NVVXMUVWVkMHBRUPXgwfYBdeGFxVCwkSSVgMVFAdGUdQQA==","queueTime":0,"applicationTime":0,"atts":"GRJURw1MRU0=","errorBeacon":"bam.nr-data.net","agent":""}</script>
</body>
</body>
</html>