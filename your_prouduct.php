    ...
    <div class="w3ls_w3l_banner_nav_right_grid" id="focus"> <br>
      ...
      <div class="w3ls_w3l_banner_nav_right_grid1">
		...
		$search_box=$_GET['yp'];
					...
					$query_product=mysql_query($select_product)or die(mysql_error());
...
{
	$select_product="select * from product INNER JOIN brand ON brand.bid=product.bid  INNER JOIN sub_category ON sub_category.s_cid=product.s_cid INNER JOIN category ON sub_category.cid=category.cid WHERE  cname LIKE '%".$search_box."%' OR s_cname LIKE '%".$search_box."%' OR bname LIKE '%".$search_box."%'  OR  pname LIKE '%".$search_box."%' ";
              ...
              <div class="agile_top_brand_left_grid1">
                <figure>
                  <div class="snipcart-item block">
                    <div class="snipcart-thumb"> <a href="single.php?pid=<?php echo $fetch_product['pid']; ?>"><img style="height:180px;" title="" alt="" src="life\product_images_upload\<?php echo $fetch_product['pimage']; ?>"  class="img-responsive"></a>
                      <p style="height:65px; border:0px solid red; "><?php echo $fetch_product['pname']; ?></p>
                      <h4>₹<?php echo $fetch_product['oprice']; ?><span></span></h4>
                    </div>
                    <div class="snipcart-details top_brand_home_details">
                      <form action="" method="post" >
                        <fieldset>
