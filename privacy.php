...
<div class="products-breadcrumb">
  <div class="container">
    <ul>
      ...
      <li><a href="privacy.php">Privacy Policy & Terms of Use</a></li>
    </ul>
  </div>
</div>
<!-- //products-breadcrumb --> 
      ...
      <div class="privacy1">
        ...
        <div class="banner-bottom-grid1 privacy1-grid">
          <ul>
            ...
            <li>Profile <span>We collect personal information such as your name, address, email address, and phone number when you create an account or place an order on our website.</span></li>
          </ul>
          <ul>
            <li><i class="glyphicon glyphicon-search" aria-hidden="true"></i></li>
            <li>Search <span>A search policy outlines how searches are conducted within an organization. For an online grocery store, this includes guidelines for searching customer data, conducting physical store searches, and handling customer search queries. The aim is to ensure that searches are fair, transparent, and lawful while protecting the privacy of customers and employees.</span></li>
          </ul>
          <!---728x90--->
          <ul>
            <li><i class="glyphicon glyphicon-paste" aria-hidden="true"></i></li>
            <li>News Feed <span>News feed policy sets guidelines for selecting and displaying relevant and accurate content on a website or social media platform. It includes rules for promotional content, product reviews, and sharing company/industry news. The goal is to provide customers with useful information and insights while ensuring the content is unbiased.</span></li>
          </ul>
        </div>
      </div>
      <div class="privacy1">
        ...
        <div class="banner-bottom-grid1 privacy2-grid">
          <div class="privacy2-grid1">
            ...
            <p>Personal Information: <br>We collect personal information such as your name, address, email address, and phone number when you create an account or place an order on our website.<br>
Payment Information: <br>We collect payment information such as credit card or debit card numbers, billing address, and other information required to process your payment.<br>
Usage Information: <br>We collect information about your use of our website, including your browsing history, search queries, and other information about how you interact with our website.</p>
            <div class="privacy2-grid1-sub">
              <h5>1. We use your personal information to:</h5>
              <p>Process your orders and provide you with our services<br>
Communicate with you about your orders and our services<br>
Improve our website and services<br>
Send you promotional emails about our products and services</p>
            </div>
            <div class="privacy2-grid1-sub">
              <h5>2.We may also disclose your personal information:</h5>
              <p>To our service providers who assist us with providing our services<br>
To comply with legal obligations, such as responding to a subpoena or court order<br>
To protect our rights or property, or the safety of our customers or others</p>
            </div>
            <div class="privacy2-grid1-sub">
              <h5>3. Security of Information:</h5>
              <p>We take reasonable measures to protect your personal information from unauthorized access, use, and disclosure. We use encryption and other security measures to protect your payment information.</p>
            </div>
            <div class="privacy2-grid1-sub">
              <h5>4.Third-Party Websites:</h5>
              <p>Our website may contain links to third-party websites. We are not responsible for the privacy practices or content of those websites. We encourage you to read the privacy policies of those websites.</p>
            </div>
            <div class="privacy2-grid1-sub">
              <h5>5.Updates to Privacy Policy:</h5>
              <p>We may update this privacy policy from time to time. We will notify you of any material changes to this policy by posting a notice on our website.</p>
              <h5>6.Contact Us:</h5>
              <p>If you have any questions or concerns about this privacy policy or our handling of your personal information, please contact us.</p>
            </div>
          </div>
        </div>
      </div>
