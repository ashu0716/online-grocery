...
<head>
<?php
$select_sub_category_title="select * from sub_category where s_cid='$s_cid' ";
$result_sub_category_title=mysqli_query($conn,$select_sub_category_title)or die(mysqli_error($conn));
$row_sub_category_title=mysqli_fetch_array($result_sub_category_title);
?>
<title><?php echo $row_sub_category_title['s_cname']; ?>&nbsp;Products</title>
<?php
  ...
  <div class="container">
    <ul>
      <li><i class="fa fa-home" aria-hidden="true"></i><a href="index.php">Home</a><span>|</span></li>
       <li style="color:#FFF;"> <a href=""><?php echo $row_sub_category_title['s_cname']; ?> </a> </li>
    </ul>
  </div>
</div>
<!-- //products-breadcrumb --> 
...
?>
  ...
  <div class="w3l_banner_nav_right"> 
    ...
    <!---728x90--->
    <div class="w3ls_w3l_banner_nav_right_grid" id="focus"> <br>
      <?php
			//$cname=$row_category['cname'];
			  $select_sub_category="select * from sub_category where s_cid='$s_cid' ";
			  $query_sub_category=mysqli_query($conn, $select_sub_category) or die(mysqli_error($conn));
              while($fetch_sub_category=mysqli_fetch_array($query_sub_category))
     		  {
			  ?>
      <h3><?php echo $fetch_sub_category['s_cname']; ?> Product's</h3>
      <div class="w3ls_w3l_banner_nav_right_grid1">
        <?php
			  		$s_cname=$fetch_sub_category['s_cname'];
					
			  		$select_product="select * from product INNER JOIN brand ON brand.bid=product.bid  INNER JOIN sub_category ON sub_category.s_cid=product.s_cid INNER JOIN category ON sub_category.cid=category.cid where s_cname='$s_cname' ";
    ...
    <div class="modal-content" >
	 ...
	 .cart:hover
	 {
        ...
        <p class="cart"> &nbsp;&nbsp;&nbsp;&nbsp;We Are Extremly Sorry !!<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You need to SIGN IN to BUY your PRODUCT ? </p>
      </div>
