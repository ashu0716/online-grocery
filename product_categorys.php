  ...
  <div class="w3l_banner_nav_right"> 
    ...
    <div class="w3l_banner_nav_right_banner3_btm">
      ...
      <div class="col-md-4 w3l_banner_nav_right_banner3_btml" style=" border:0px solid red; padding-right:0px; padding-left:15px;">
        <div class="view view-tenth"  style=" border:0px solid red;"> <img src="life/sub_category_images_upload/<?php echo $fetch_sub_category['s_cphoto']; ?>" alt=" " class="img-responsive"> <a href="sub_category_products.php?s_cid=<?php echo $fetch_sub_category['s_cid']; ?>">
