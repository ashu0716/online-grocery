...
<div class="col-sm-4 col-md-3 m-b-3">
          <h3 class="text-center m-b-3" style="text-transform:capitalize; color:#F00; font-size:30px;"><?php echo $username_client=$fetch_client['clint_uname']; ?></h3>
          <br>
			<style>
			.active-account
			{
			...
			#account-profile:hover a,#account-address:hover a,#account-history:hover a,#account-password:hover a
			{
          ...
          <ul class="nav nav-pills nav-stacked">
           <li id="account-profile" ><a href="account-profiles.php">My Profile</a></li>
            <li id="account-address" ><a href="account-addresss.php">My Address</a></li>
            <li id="account-password"  class="active-account"><a href="account-passwords.php">Change Password</a></li>
          </ul>
        </div>
        <!-- End Account Sidebar -->
        ...
        <div class="col-sm-8 col-md-9">
          <div class="title m-b-2" style="margin-bottom:20px; font-size:20px; font-weight:500;"><span style="color:#00F; font-size:22px;"> Change Password</span></div>
          <div class="row">
           <div class="col-xs-12">
              <ul class="list-group list-group-nav">
                ...
                <?php
              $select_client_password="select * from client where clint_uname='".$uname."' ";
		$result_client_password=mysqli_query($conn,$select_client_password)or die("Query Not Made");
		$row_client_password=mysqli_fetch_array($result_client_password);
			  ?>
                <li class="list-group-item">
                  <label for="oldInputPasswd" style="color:#F00;">Old Password</label>
                  <input value="<?php echo $row_client_password['clint_pass']?>" disabled type="password" class="form-control" name="oldInputPasswd" id="oldInputPasswd" placeholder="Old Password" style="width: 100%;    border: 1px solid #d9d9d9;  margin-top:7px;    padding: 7px 7px;   font-weight:700;  font-size: 14px; color:#84C639; background-color:transparent; " >
                </li>
                <li class="list-group-item">
                  <label for="newInputPasswd" style="color:#F00;">New Password</label>
                  <span id="sprypassword1">
                  <input type="password" class="form-control" name="newInputPasswd" id="newInputPasswd" placeholder="New Password"  style="width: 100%;    border: 1px solid #d9d9d9;  margin-top:7px;    padding: 7px 7px;   font-weight:700;  font-size: 14px; color:#84C639; background-color:transparent; " >
                  <span class="passwordRequiredMsg">New Password is required.</span></span></li>
                <li class="list-group-item">
                  <label for="retypeInputPasswd" style="color:#F00;">Re-type New Password</label>
                  <span id="spryconfirm1">
                  <input type="password" class="form-control" name="retypeInputPasswd" id="retypeInputPasswd" placeholder="Re-type New Password"  style="width: 100%;    border: 1px solid #d9d9d9;  margin-top:7px;    padding: 7px 7px;   font-weight:700;  font-size: 14px; color:#84C639; background-color:transparent; " >
                  <span class="confirmRequiredMsg">Re-type New Password is required.</span><span class="confirmInvalidMsg">Re-type New Password don't match.</span></span></li>
             <style>
             	#edit-account:hover 		
				{
			...
			border:none;
              ...
              <button type="submit" name="save_password"  id="edit-account" class="btn btn-success pull-right">
              <i class="fa fa-pencil"></i> &nbsp;Save My Password
              </button>
		  ...
		  {
		  $new_password=$_POST['newInputPasswd'];
		$update_client="update client set clint_pass='".$new_password."' where clint_uname='".$uname."' ";
		mysqli_query($conn,$update_client)or die("Query Not Made");
		header("location:account-profiles.php");
}
?>        
...
<script type="text/javascript">
window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"26612e640c","applicationID":"3365418","transactionName":"NVVXMUVWVkMHBRUPXgwfYBdeGFxVCwkSSVgMVFAdGUdQQA==","queueTime":0,"applicationTime":1,"atts":"GRJURw1MRU0=","errorBeacon":"bam.nr-data.net","agent":""}
var sprypassword1 = new Spry.Widget.ValidationPassword("sprypassword1");
var spryconfirm1 = new Spry.Widget.ValidationConfirm("spryconfirm1", "newInputPasswd");
</script>
</body>
</body>
</html>
