      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-md-3 m-b-3">
          ...
          <ul class="nav nav-pills nav-stacked">
           <li id="account-profile"  class="active-account"><a href="account-profiles.php">My Profile</a></li>
        ...
        <div class="col-sm-8 col-md-9">
          <div class="title m-b-2" style="margin-bottom:20px; font-size:20px; font-weight:500;"><span style="color:#00F; font-size:22px;"> Editing My Profile</span>
</div>
          <div class="row">
            <div class="col-xs-12">
              <ul class="list-group list-group-nav">
                ...
                <li class="list-group-item">
                  ...
                  <p><input style="width: 100%;    border: 1px solid #d9d9d9;  margin-top:7px;    padding: 7px 7px;   font-weight:500;  
                   font-size: 14px; color:#F00; background-color:transparent; " disabled type="text" name="username" id="username" value="<?php echo $username_client=$fetch_client['clint_uname']; ?>"></p>
                </li>
                <li class="list-group-item">
                  <strong>Email Address</strong>
                  <p><input style="width: 100%;    border: 1px solid #d9d9d9;  margin-top:7px;    padding: 7px 7px;   font-weight:500;  
                   font-size: 14px; color:#F00; " type="text" name="email_id" id="email_id" value="<?php echo $email_client=$fetch_client['clint_email']; ?>"></p>
                </li>
                <li class="list-group-item">
                  <strong>Phone Number</strong>
                  <p><input style="width: 100%;    border: 1px solid #d9d9d9;  margin-top:7px;    padding: 7px 7px;   font-weight:500;  
                   font-size: 14px; color:#F00; " type="text" name="mobile_no" id="mobile_no" maxlength="10" value="<?php echo $mob_client=$fetch_client['clint_mob']; ?>"></p>
                </li>
			...
			border:none;
              ...
              <button type="submit" name="update_profile" id="edit-account" class="btn btn-success pull-right">
			  ...
			  if(isset($_POST['update_profile']))
			  {
				  ...
				  $update_profile_update="update client set clint_email='$email_id' , clint_mob='$mobile_no' where clint_id='$clint' ";
				  $query_profile_update=mysqli_query($conn,$update_profile_update)or die(mysqli_error());
				  if($query_profile_update > 0)
				  {
