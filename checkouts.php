  ...
  <div class="container">
    ...
    <div class="w3ls_logo_products_left1">
      <ul class="phone_email">
        ...
        <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:<?php echo $row_shop_details['s_d_email']; ?>">
		<?php echo $row_shop_details['s_d_email']; ?></a></li>
      </ul>
    </div>
...
<br>
<table style="margin:0 auto; width:95%;  background-color:#FFFFFF; text-align:center; vertical-align:middle; border-radius:30px;  border-color: #000000; border: 2px;" >
 ...
 {
	 ?>
  <tr style="font-size:16px; font-weight:700; font-style:italic; color:#930; height:25px;  border-bottom:3px solid white; border-top:3px solid white; ">
      <td  style="width:100%;" colspan="5"></td>
  </tr>

  <tr style="font-size:18px; font-weight:700; font-style:italic;  background-color:#F00; color:#FFF; height:50px;  border-bottom:3px solid white; border-top:3px solid white; ">
            <td  > Product Image </td>
            <td  style="border-left:3px solid #FFFFFF; border-right:3px solid #FFFFFF;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Product Name </td>
            <td  > Price </td>
            <td   style="border-left:3px solid #FFFFFF; border-right:3px solid #FFFFFF;"> Quantity & Action </td>
            <td  > Total Price </td>
  </tr>
 ...
 ?>
       ...
       .img-zoom {
		...
		.transition {
          ...
          <tr style="font-size:14px; font-weight:700; font-style:italic; color:#930; height:40px;  border-bottom:3px solid white; border-top:3px solid white; ">
            <td  style="width:15%;">
            <img class="img-zoom" src="life/product_images_upload/<?php echo $fetch_cart['pimage']; ?>" style="height:30px; border:0px solid red;"></td>
    
            <td  style=" width:45%; border-left:3px solid white; border-right:3px solid white; text-align:left; height:30px;">
            <p style="width:96%; font-weight:700; height:30px; margin:0 auto; border:0px solid red;"> 
     ...
     ?>           
            ...
            <td style="width:10%;" >₹&nbsp;&nbsp;
              <input  type="text" name="product_price" id="product_price"   value="<?php echo $fetch_cart['oprice']; ?>"  
              style=" width:45px; background-color:transparent; border:0px solid red;"  disabled ></td>
              
            
  
            <td style="width:18%; border-left:3px solid white; border-right:3px solid white; ">
          <form  style=" border:0px solid red; margin:0px auto;" method="get" action="update_carts.php">
            <input type="text" name="product_quantity" id="product_quantity"  value="<?php echo $fetch_cart['qty']; ?>" 
    style="border:none; width:70px; height:28px; text-align:center; border-radius:50%; " maxlength="3" >
            <input type="hidden" name="crt_id" id="crt_id"  value="<?php echo $fetch_cart['crt_id']; ?>" 
    style="border:none; width:40px; height:28px; text-align:center; border-radius:50%;" maxlength="3" >
            &nbsp;&nbsp;&nbsp; <a href="">
            <input type="submit" value="U" style="border-radius:50%; border:none; color:#03F; width:40px; height:28px; font-size:14px; font-style:normal;"  >
            </a> &nbsp; <a href="delete_carts.php?crt_id=<?php echo $fetch_cart['crt_id']; ?>">
            <input type="button" value="X" style="border-radius:50%; border:none; color:#F00; width:40px; height:28px; font-size:14px; font-style:normal;">
            </a>
          </form>
          </td>
          ...
          <td style="width:12%;" align="right" >₹&nbsp;&nbsp;
            <input name="product_our_price" type="text" id="product_our_price" value="<?php echo $total; ?>"
    style=" width:65px; background-color:transparent; border:0px solid red;"  readonly >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
       </tr>
        
          <tr hidden="" style="font-size:18px; font-weight:700; font-style:italic; color:#930; height:40px;  border-bottom:3px solid white; border-top:3px solid white; " >
            <td  colspan="1"  >  </td>
            <td colspan="4"><?php  echo $grand_total_chechout= $grand_total_chechout + $total ; ?></td>
          </tr>
          
           <?php
	 }
?>
          <tr  style="font-size:20px; font-weight:700; font-style:italic; color:#FFF; height:40px;  border-bottom:3px solid white; border-top:3px solid white; 
 background-color:#F00;">
            <td colspan="4" align="right" >Grand Total : </td>
            <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;₹&nbsp;<?php echo $grand_total_chechout ; ?></td>
          </tr>
      ...
      <br>
          ...
          <div class="row" style=" border:0px solid red; width:95%; margin:0px auto;">
            <div class="col-xs-6"  >
              <div class="btn-group pull-left" role="group" aria-label="..." > <a href="indexs.php">
                <button type="button" style="float:right; background-color:#F00; border:none; font-size:16px; width:170px; height:40px;" class="btn btn-default btn-info" onClick="indexs.php"><span class="fa fa-arrow-left"></span>&nbsp;Back to Products</button>
              </div>
            </div>
            <div class="col-xs-6" >
              <div class="btn-group pull-right" role="group" aria-label="..." > <a href="billing_addresss.php">
                <button type="button" style=" background-color:#84C639; border:none; font-size:16px; width:170px; height:40px;" class="btn btn-default btn-success"  ><span class="fa fa-shopping-cart"></span>&nbsp;Checkout</button>
                </a> </div>
            </div>
          </div>
 ...
 else
 {
	 ...
	 .cart:hover
	 {
		 ...
		 color:#FFF;
          ...
          <table style="margin:0 auto; width:95%;  background-color:#84C639; text-align:center; vertical-align:middle; border-radius:30px; " >
          ...
          <div class="row" style=" border:0px solid red; width:95%; margin:0px auto;">
            <div class="col-xs-6"  >
              <div class="btn-group pull-left" role="group" aria-label="..." > <a href="indexs.php">
                <button type="button" style="float:right; background-color:#F00; border:none; font-size:16px; width:170px; height:40px;" class="btn btn-default btn-info" onClick="indexss.php"><span class="fa fa-arrow-left"></span>&nbsp;Back to Products</button>
              </div>
            </div>
