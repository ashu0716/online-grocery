...
<head>
<?php
$select_category_title="select * from category where cid='$cid' ";
$result_category_title=mysqli_query($conn, $select_category_title)or die(mysqli_error($conn));
$row_category_title=mysqli_fetch_array($result_category_title);
?>
<title><?php echo $row_category_title['cname']; ?>&nbsp;Products</title>
<?php
...
<div class="products-breadcrumb">
  <div class="container">
    <ul>
      ...
      <li style="color:#FFF;">
        <?php
$select_category="select * from category where cid='$cid'";
$result_category=mysqli_query($conn, $select_category)or die(mysqli_error($conn));
$row_category=mysqli_fetch_array($result_category);
?>
        <a href=""><?php echo $row_category['cname'];?> </a></li>
    </ul>
  </div>
</div>
<!-- //products-breadcrumb --> 
    ...
    <div class="w3l_banner_nav_right_banner3_btm">
      <?php 
			$cname=$row_category['cname'];
			  $select_sub_category="select * from sub_category INNER JOIN category ON category.cid=sub_category.cid  where cname='$cname' ";
              ...
              while($fetch_sub_category=mysqli_fetch_array($query_sub_category))
     		  {
			  ?>
      <div class="col-md-4 w3l_banner_nav_right_banner3_btml" style=" border:0px solid red; padding-right:0px; padding-left:15px;">
        <div class="view view-tenth"  style=" border:0px solid red;"> <img src="life/sub_category_images_upload/<?php echo $fetch_sub_category['s_cphoto']; ?>" alt=" " class="img-responsive"> <a href="sub_category_product.php?s_cid=<?php echo $fetch_sub_category['s_cid']; ?>">
          <div class="mask" style="background-image:url(life/img/bg.png);">
            <h4 style="background-color:#000;"><?php echo $fetch_sub_category['cname']; ?></h4>
            <p style="background-color:#F00;"><?php echo $fetch_sub_category['s_cname']; ?></p>
          </div>
          </a> </div>
        <h4></h4>
      </div>
