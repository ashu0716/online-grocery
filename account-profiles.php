...
<div class="container m-t-3">
      <div class="row">
        ...
        <div class="col-sm-8 col-md-9">
          <div class="title m-b-2" style="margin-bottom:20px; font-size:20px; font-weight:500;"><span style="color:#00F; font-size:22px;"> My Profile</span>
</div>
          <div class="row">
            <div class="col-xs-12">
              <ul class="list-group list-group-nav">
                ...
                <li class="list-group-item">
                  <strong style="color:#F00;" >Username</strong>
                  <p><input disabled style="width: 100%;    border: 1px solid #FFFFFF;  margin-top:5px;  font-weight:500;  
                   font-size: 14px; color:#000000; background-color:transparent; " type="text" value="<?php echo $username_client=$fetch_client['clint_uname']; ?>"></p>
                </li>
                <li class="list-group-item">
                  <strong style="color:#F00;" >Email Address</strong>
                  <p><input disabled style="width: 100%;    border: 1px solid #FFFFFF;  margin-top:5px;  font-weight:500;  
                   font-size: 14px; color:#000000; background-color:transparent; " type="text" value="<?php echo $email_client=$fetch_client['clint_email']; ?>"></p>
                </li>
                <li class="list-group-item">
                  <strong style="color:#F00;" >Phone Number</strong>
                  <p><input disabled style="width: 100%;    border: 1px solid #FFFFFF;  margin-top:5px;  font-weight:500;  
                   font-size: 14px; color:#000000; background-color:transparent; " type="text" value="<?php echo $mob_client=$fetch_client['clint_mob']; ?>"></p>
                </li>
             <style>
             	#edit-account:hover 		
				{
			...
			border:none;
              ...
              <a href="edit-account-profiles.php" id="edit-account" class="btn btn-success pull-right">
