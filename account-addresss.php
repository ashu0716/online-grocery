...
<div class="col-sm-4 col-md-3 m-b-3">
        ...
        <div class="col-sm-8 col-md-9">
          <div class="title m-b-2" style="margin-bottom:20px; font-size:20px; font-weight:500;"><span style="color:#00F; font-size:22px;"> My Address</span></div>
          <div class="row">
            <div class="col-xs-12">
			  ...
			  ?>
                ...
                <li class="list-group-item">
                  <strong style="color:#F00;" >Full Name</strong>
                  <p><input disabled style="width: 100%;    border: 1px solid #FFFFFF;  margin-top:5px;  font-weight:500;  
                   font-size: 14px; color:#000000; background-color:transparent; " type="text" value=" <?php echo $fullname; ?>"></p>
                </li>
                <li class="list-group-item">
                  <strong style="color:#F00;" >Address</strong>
                  <p><textarea disabled style="width: 100%; height:25px;    border: none;  margin-top:5px;  font-weight:500;  
                   font-size: 14px; color:#000000; background-color:transparent; " > <?php echo $address; ?> </textarea></p>
                </li>
                
                <li class="list-group-item">
                  <strong style="color:#F00;" >City</strong>
                  <p><input disabled style="width: 100%;    border: 1px solid #FFFFFF;  margin-top:5px;  font-weight:500;  
                   font-size: 14px; color:#000000; background-color:transparent; " type="text" value=" <?php echo $city; ?>"></p>
                </li>
                <li class="list-group-item">
                  <strong style="color:#F00;" >Post Code</strong>
                  <p><input disabled style="width: 100%;    border: 1px solid #FFFFFF;  margin-top:5px;  font-weight:500;  
                   font-size: 14px; color:#000000; background-color:transparent; " type="text" value=" <?php echo $pincode; ?>"></p>
                </li>
                <style>
             	#edit-account:hover 		
				{
			...
			border:none;
              ...
              <a id="edit-account" href="edit-account-addresss.php" class="btn btn-success pull-right">
              <i class="fa fa-pencil"></i> &nbsp;Edit My Address</a>
              </ul> <br>
            </div>
          </div>
        </div>
