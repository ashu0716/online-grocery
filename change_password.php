...
<div class="logo_products">
  <div class="container">
    ...
    <?php
					...
					$result_shop_details=mysql_query($select_shop_details)or die(mysql_error());
					$row_shop_details=mysql_fetch_array($result_shop_details)
					?>
    <div class="w3ls_logo_products_left1">
    ...
    <div class="mail" >
      ...
      <!---728x90--->
        ...
        <div class="col-md-12 agileinfo_mail_grid_right" >
          ...
          <?php
              $select="select * from client where uname='".$uname."' ";
		$result=mysql_query($select)or die("Query Not Made");
		$row=mysql_fetch_array($result);
			  ?>
            
            <div class="col-md-12 wthree_contact_left_grid" >
            <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500;" >Old Password : </p><input type="password" name="old_password" id="old_password" value="<?php echo $row['pass']?>" disabled style="outline: none; padding: 10px; font-size: 14px;color: #212121;background: #f5f5f5; width: 100%; border: 1px solid #E6E6E6;margin-top: 5px;margin-bottom:5px; ">
            
           <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500;" >New Password : </p><input type="password" name="new_password" id="new_password" placeholder="New Password" style="outline: none; padding: 10px; font-size: 14px;color: #212121;background: #f5f5f5; width: 100%; border: 1px solid #E6E6E6;margin-top: 5px;margin-bottom:5px;">
            
           <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500;" >Confirm Password : </p><input type="password" name="confirm_password" id="confirm_password" placeholder="Confirm Password" style="outline: none; padding: 10px; font-size: 14px;color: #212121;background: #f5f5f5; width: 100%; border: 1px solid #E6E6E6;margin-top: 5px;margin-bottom:5px;">
            </div>
            <div class="clearfix"> </div>
            <br>
            
            <input type="submit" name="change" value="Change Password" >
            <input type="reset" value="Cancel" style="background-color:#F00;">
...
if(isset($_POST['change']))
{
  ...
  $uname = mysqli_real_escape_string($conn, $_POST['uname']); // Escape user input to prevent SQL injection
  $update = "UPDATE client SET pass='$hashed_password' WHERE uname='$uname'";
