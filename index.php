...
{
?>
          <li class="dropdown mega-dropdown active"> <a href="<?php echo $row['cname'];?>.php" class="dropdown-toggle" data-toggle="dropdown"> <?php echo $row['cname'];?><span class="caret"></span></a>
            <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
			  ...
			  $cname=$row['cname'];
						$select1="select * from sub_category INNER JOIN category ON category.cid=sub_category.cid where cname='$cname' order by s_cname ";
								$result1=mysqli_query($conn,$select1)or die(mysqli_error());
								while ($row1=mysqli_fetch_array($result1))
								{
								?>
              <div class="w3ls_vegetables">
                <ul>
                  <li><a href="product.php?s_cid=<?php echo $row1['s_cid']; ?>"><?php echo $row1['s_cname']; ?></a></li>
                </ul>
              </div>
              <?php
								}
  ...
  <div class="w3l_banner_nav_right">
    <section class="slider">
      <div class="flexslider">
        <ul class="slides">
          <?php
          $select_slider="select * from slider where sstatus='Active' ";
$result_slider=mysqli_query($conn,$select_slider)or die(mysqli_error());
while($row_slider=mysqli_fetch_array($result_slider))
{
		  ?>
          <li> <img src="life/slider_images_upload/<?php echo $row_slider['simage']; ?>" alt=" " style="width:100%; height:410px;" class="img-responsive" > </li>
          <?php
          }
		  ?>
        </ul>
  ...
  <div class="container">
    ...
    <div class="agile_top_brands_grids">
      <?php
			  ...
			  $select_product="select * from product INNER JOIN brand ON brand.bid=product.bid  INNER JOIN sub_category ON sub_category.s_cid=product.s_cid INNER JOIN category ON sub_category.cid=category.cid ";
            ...
            <div class="agile_top_brand_left_grid1">
              <figure>
                <div class="snipcart-item block">
                  <div class="snipcart-thumb"> <a href="single.php?pid=<?php echo $fetch_product['pid']; ?>"><img style="height:180px;" title="" alt="" src="life\product_images_upload\<?php echo $fetch_product['pimage']; ?>"  class="img-responsive"></a>
                  ...
                  <div class="snipcart-details top_brand_home_details">
                    <form action="" method="post" >
                      <fieldset>
                        ...
                        <input id="addtocart" type="button" name="cart" value="Add To Cart" class="button"  data-toggle="modal" data-target="#myModal">
                        <?php
                        }
                        else
                        {
...
<div class="modal fade" id="myModal" role="dialog">
  <div class="modal-dialog"> 
    ...
    <!-- Modal content    style="background-image:url(life/img/bg.png);" -->
    <div class="modal-content" >
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" style="font-size:40px; color:#F00; font-weight:900;">&times;</button>
        <h4 class="modal-title" style="font-size:36px; font-weight:900; letter-spacing:3px;  color:#84C639;" >SIGN IN !!!</h4>
      </div>
	 ...
	 .cart:hover
	 {
        ...
        <p class="cart"> &nbsp;&nbsp;&nbsp;&nbsp;We Are Extremly Sorry !!<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You need to SIGN IN to BUY your PRODUCT ?
          </p>
      ...
      <div class="modal-footer">
        <div class="row" style=" border:0px solid red;">
          <div class="col-xs-6"  >
            <div class="btn-group pull-left" role="group" aria-label="..." > <a href="index.php">
              <button type="button" style="float:right; background-color:#F00; border:none; width:160px; height:50px; font-size:18px; " class="btn btn-default btn-info" ><span class="fa fa-arrow-left"></span>&nbsp;&nbsp;Back to Home</button>
            </div>
          </div>
          <div class="col-xs-6" >
            <div class="btn-group pull-right" role="group" aria-label="..." > <a href="login.php">
              <button type="button" style=" background-color:#84C639; border:none; width:160px; height:50px; font-size:18px;" class="btn btn-default btn-success"  ><span class="glyphicon glyphicon-log-in"></span>&nbsp;&nbsp;Sign In</button>
              </a> </div>
          </div>
        </div>
      </div>
    ...
    <div class="w3l_fresh_vegetables_grids">
      <div class="col-md-3 w3l_fresh_vegetables_grid w3l_fresh_vegetables_grid_left">
        <div class="w3l_fresh_vegetables_grid2">
          <ul>
            <li><i class="fa fa-check" aria-hidden="true"></i><a href="all_brand.php">All Brands</a></li>
            <?php
$select_category="select * from category ORDER BY cname;";
$result_category=mysqli_query($conn,$select_category)or die(mysqli_error());
while($row_category=mysqli_fetch_array($result_category))
{
?>
            <li><i class="fa fa-check" aria-hidden="true"></i><a href="product_category.php?cid=<?php echo $row_category['cid'];?>"><?php echo $row_category['cname'];?></a></li>
            <?php 
  } 
  ?>
          </ul>
      ...
      <div class="col-md-9 w3l_fresh_vegetables_grid_right">
        <div class="col-md-4 w3l_fresh_vegetables_grid">
          <div class="w3l_fresh_vegetables_grid1"> <img src="images/8.jpg" alt=" " class="img-responsive"> </div>
        </div>
        <div class="col-md-4 w3l_fresh_vegetables_grid">
          <div class="w3l_fresh_vegetables_grid1">
            <div class="w3l_fresh_vegetables_grid1_rel"> <img src="images/7.jpg" alt=" " class="img-responsive">
              <div class="w3l_fresh_vegetables_grid1_rel_pos">
                <div class="more m1"> <a href="all_product.php" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a> </div>
              </div>
            </div>
          </div>
          <div class="w3l_fresh_vegetables_grid1_bottom"> <img src="images/10.jpg" alt=" " class="img-responsive">
        ...
        <div class="col-md-4 w3l_fresh_vegetables_grid">
          <div class="w3l_fresh_vegetables_grid1"> <img src="images/9.jpg" alt=" " class="img-responsive"> </div>
          <div class="w3l_fresh_vegetables_grid1_bottom"> <img src="images/11.jpg" alt=" " class="img-responsive"> </div>
        </div>
        <div class="clearfix"> </div>
