...
<!-- //products-breadcrumb --> 
    ...
    <div class="privacy about">
      <h3>About Us</h3>
      <p class="animi"  style="font-size:16px;"><?php echo $row_shop_details['s_d_descr']; ?></p>
      <!---728x90--->
      <div class="agile_about_grids">
        <div class="col-md-6 agile_about_grid_right"> <img style="width:600px; height:250px" src="life\shop_images_upload\<?php echo $row_shop_details['s_d_image']; ?>" alt=" " class="img-responsive"> </div>
        <div class="col-md-6 agile_about_grid_left">
          <ul style="list-style:none;">
            <li style="font-size:16px;"><?php echo $row_shop_details['s_d_add']; ?></li>
            <br>
            <li style="font-size:16px;"><?php echo $row_shop_details['s_d_email']; ?></li>
            <br>
            <li style="font-size:16px;"><?php echo $row_shop_details['s_d_ph']; ?></li>
            <br>
            <li style="font-size:16px;"><?php echo $row_shop_details['s_d_web']; ?></li>
          </ul>
        </div>
        <div class="clearfix"> </div>
      </div>
...
<!---728x90---> 
<!-- team -->
<div class="team" style="background-color: #FFF;">
  <div class="container">
    <h3>Meet Our Amazing Team</h3>
    <div class="agileits_team_grids">
      <div class="col-md-3 agileits_team_grid"> <img src="images\32.jpg" alt=" " class="img-responsive">
        <h4>Martin Paul</h4>
        <p>Manager</p>
      ...
      <div class="col-md-3 agileits_team_grid"> <img src="images\33.jpg" alt=" " class="img-responsive">
        <h4>Michael Rick</h4>
        <p>Supervisor</p>
        <ul class="agileits_social_icons agileits_social_icons_team">
          <li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
      ...
      <div class="col-md-3 agileits_team_grid"> <img src="images\34.jpg" alt=" " class="img-responsive">
        <h4>Thomas Carl</h4>
        <p>Supervisor</p>
        <ul class="agileits_social_icons agileits_social_icons_team">
          <li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
      ...
      <div class="col-md-3 agileits_team_grid"> <img src="images\35.jpg" alt=" " class="img-responsive">
        <h4>Laura Lee</h4>
        <p>CEO</p>
        <ul class="agileits_social_icons agileits_social_icons_team">
          <li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
