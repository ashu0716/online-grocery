...
<div class="products-breadcrumb">
  <div class="container">
	...
	<div class="banner" style="width:60%; margin:0px auto; border:0px solid red; ">
    
  <table width="100%" border="0" style="margin-top:50px;">
  <tr>
    <td colspan="3" style=" font-size:30px; " >
    <form method="post" action="" name="shipping_address_billing_address" id="shipping_address_billing_address">
    If Shipping Address Same as Billing Address <button type="submit" name="same_address" id="same_address" style="border:none; background-color:transparent;"><a>Click Here!</a></button>
    </form>
       <?php
			if(isset($_POST['same_address']))
			{	
						header('location:shipping_addressss.php');
			}
			?>
  <br>
  ...
  <tr>
    <td style="color:#84C639; font-size:16px; width:49%; border:0px solid red; text-align:center;">___________________________________________________</td>
    <td style="width:1%;"><b style="font-size:36px; vertical-align:bottom; ">&nbsp;O&nbsp;R&nbsp;</b></td>
    <td style="color:#84C639; font-size:16px; width:50%; border:0px solid red;">___________________________________________________</td>
...
<br>
    ...
    <!-- mail -->
    <div class="mail" style="padding:20px;">
        <div class="col-md-12 agileinfo_mail_grid_right" >
          <form  method="post" action="" >
            <h3 > Shipping Address</h3>
    		  <div class="col-md-12 wthree_contact_left_grid">
              <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500;" >Full Name : </p>
              <input type="text" name="full_name" placeholder="Full Name" >
            </div>
            <div class="col-md-6 wthree_contact_left_grid">
              <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500;" >@-Mail : </p>
              <input type="text" name="email_id" placeholder="@-Mail" >
              <p style="margin-top:15px; margin-bottom:15px; font-size:18px; color:#000; font-weight:500;" >Mobile Number : </p>
              <input type="text" name="mobile_no" placeholder="Mobile Number" maxlength="10" >
            </div>
            <div class="col-md-6 wthree_contact_left_grid">
              <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500;" >City : </p>
              <input type="text" name="city" placeholder="City" >
              <p style="margin-top:15px; margin-bottom:15px; font-size:18px; color:#000; font-weight:500;" >Pin Code : </p>
              <input type="text" name="pincode" placeholder="Pin Code" maxlength="6">
            </div>
            <div class="col-md-12 wthree_contact_left_grid" >
              <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500; " >Address : </p>
            </div>
              <textarea  name="address" placeholder="Address" ></textarea>
            <div class="clearfix"> </div>
            <input type="submit" name="insert_update_order" value="Confirm Order">
            <input type="reset" value="Clear" style="background-color:#F00;">
            
			<?php
				if (isset($_POST['ship_flname'])) {
  $fullname = $_POST['ship_flname'];
} else {
  $fullname = "";
}
...
if (isset($_POST['ship_mob'])) {
  $mobile_no = $_POST['ship_mob'];
} else {
  $mobile_no = "";
}
...
if (isset($_POST['ship_pincode'])) {
  $pincode = $_POST['ship_pincode'];
} else {
  $pincode = "";
}

				$date_ship=date("j F Y");
				
			$select_shipping_address_select="select * from shipping_address INNER JOIN client ON shipping_address.clint_id=client.clint_id where clint_uname='$uname' ";
			$query_shipping_address_select=mysqli_query($conn,$select_shipping_address_select)or die(mysqli_error());
			$row_shipping_address_select=mysqli_num_rows($query_shipping_address_select);
			
				?>
				<?php
			if($row_shipping_address_select > 0)
			{
				if(isset($_POST['insert_update_order']))
				{
				$update_shipping_address_update="update shipping_address set ship_flname='$fullname',ship_email='$email',ship_mob='$mobile_no',ship_add='$address',ship_city='$city',ship_pincode='$pincode',ship_date='$date_ship' where clint_id='$clint' ";
				$query_shipping_address_update=mysqli_query($conn,$update_shipping_address_update);
			...
			else
			{
				if(isset($_POST['insert_update_order']))
				{
				$insert_shipping_address="insert into shipping_address values('','$clint','$fullname','$email','$mobile_no','$address','$city','$pincode','$date_ship') ";
				$query_shipping_address=mysqli_query($conn,$insert_shipping_address);
				header('location:place_orders.php');
				}
			}
			?>
