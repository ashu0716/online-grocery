...
<div class="banner" style="width:60%; margin:0px auto; border:0px solid red; ">
  <?php
			$select_billing_address="select * from billing_address INNER JOIN client ON billing_address.clint_id=client.clint_id where clint_uname='$uname' ";
			$query_billing_address=mysqli_query($conn,$select_billing_address)or die(mysqli_error());
  ...
  <table width="100%" border="0" style="margin-top:50px;">
    <tr>
      <td colspan="3"><form method="post" action="" name="shipping_address_billing_address" id="shipping_address_billing_address" style=" text-align:center; font-size:30px; ">
          <button type="submit" name="same_address" id="same_address" style="border:none; background-color:transparent;">
          <a href="shipping_addresss.php">Click Here!</a>
          </button>
          &nbsp;&nbsp; To Keep Previous Billing Address
        </form>
        <br></td>
    </tr>
    <tr>
    ...
    <div class="col-md-12 agileinfo_mail_grid_right" >
      <form  method="post" action="" >
        ...
        <div class="col-md-12 wthree_contact_left_grid">
          ...
          <p style="margin-top:15px; margin-bottom:15px; font-size:18px; color:#000; font-weight:500;" >City : </p>
        ...
        <div class="clearfix"> </div>
        <input type="submit" name="update_billing_address" value="Confirm Billing">
        ...
        <?php
			if(isset($_POST['update_billing_address']))
			{
				...
				$update_bill_address="update billing_address set bill_flname='$fullname',bill_add='$address',bill_city='$city',bill_pincode='$pincode' where clint_id='$clint' ";
				$query_bill_address=mysqli_query($conn,$update_bill_address);
				
				header('location:shipping_addresss.php');
  ...
  <div class="mail" style="padding:20px;">
    <div class="col-md-12 agileinfo_mail_grid_right" >
      <form  method="post" action="" >
        ...
        <textarea  name="address" placeholder="Address" ></textarea>
        <div class="clearfix"> </div>
        <input type="submit" name="insert_billing_address" value="Confirm Billing">
        <input type="reset" value="Clear" style="background-color:#F00;">
        <?php
			if(isset($_POST['insert_billing_address']))
			{
				$fullname=$_POST['fullname'];
				$address=$_POST['address'];
				$city=$_POST['city'];
				...
				$insert_bill_address="insert into billing_address values ('','$clint','$fullname','$address','$city','$pincode') ";
				$query_bill_address=mysqli_query($conn,$insert_bill_address);
