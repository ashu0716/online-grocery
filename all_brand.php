...
<div class="products-breadcrumb">
  <div class="container">
    <ul>
      ...
      <li ><a href="all_brand.php">Brands</a></li>
    </ul>
  </div>
</div>
<!-- //products-breadcrumb --> 
    ...
    <div class="w3ls_w3l_banner_nav_right_grid" id="focus"> <br>
      ...
      <div class="w3ls_w3l_banner_nav_right_grid1">
        <?php
					...
					$query_brand=mysqli_query($conn, $select_brand)or die(mysqli_error($conn));
					while($fetch_brand=mysqli_fetch_array($query_brand))
					{		
					?>
        <div class="col-md-3 w3ls_w3l_banner_left" style="border:1px solid white; margin-bottom:30px;">
          <div class="hover14 column">
            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid" style="border:1px solid white;" >
              <div class="agile_top_brand_left_grid1"  style="border:1px solid white;"><a  href="brand_product.php?bid=<?php echo $fetch_brand['bid']; ?>"><img style="width:100%; height:180px;" title="" alt="" src="life/brand_images_upload/<?php echo $fetch_brand['bphoto']; ?>"></a> </div>
            </div>
          </div>
        </div>
        <?php
