...
<head>
<?php
			  $select_category="select * from sub_category INNER JOIN category ON category.cid=sub_category.cid  where s_cid='$s_cid' ";
			  $query_category=mysqli_query($conn,$select_category) or die(mysqli_error());
              $fetch=mysqli_fetch_array($query_category);
			  ?>
<title><?php echo $fetch['cname']; ?>Products</title>
<?php
...
<div class="products-breadcrumb">
  <div class="container">
    <ul>
      ...
      <li style="color:#FFF;">
        <?php
$select_s="select * from sub_category INNER JOIN category ON category.cid=sub_category.cid where s_cid='$s_cid'";
$result_s=mysqli_query($conn,$select_s)or die(mysqli_error());
$row_s=mysqli_fetch_array($result_s);
?>
        <a href=""><?php echo $row_s['s_cname'];?></a></li>
    </ul>
  </div>
</div>
<!-- //products-breadcrumb --> 
  ...
  <div class="w3l_banner_nav_right"> 
    ...
    <div class="w3ls_w3l_banner_nav_right_grid"> <br>
      <?php
			  $select_category="select * from sub_category INNER JOIN category ON category.cid=sub_category.cid  where s_cid='$s_cid' ";
			  $query_category=mysqli_query($conn,$select_category) or die(mysqli_error());
              while($fetch=mysqli_fetch_array($query_category))
     		  {
			  ?>
      <h3><?php echo $fetch['cname']; ?> Products</h3>
      <div class="w3ls_w3l_banner_nav_right_grid1">
        <blockquote>
          <h6><?php echo $fetch['s_cname']; ?></h6>
        </blockquote>
        <?php
			  		$s_cname=$fetch['s_cname'];
					...
					$query_product=mysqli_query($conn,$select_product)or die(mysqli_error());
