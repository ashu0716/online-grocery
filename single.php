...
$result_logo=mysqli_query($conn, $select_logo)or die(mysql_error($conn));
...
?>
  ...
  <div class="w3l_banner_nav_right"  id="focus" >
    ...
    <div class="agileinfo_single">
      <?php
			  		$select_product="select * from product INNER JOIN brand ON brand.bid=product.bid  INNER JOIN sub_category ON sub_category.s_cid=product.s_cid INNER JOIN category ON sub_category.cid=category.cid where pid='$pid' ";
	...
	{	
					...
					?>
      <h5><?php echo $fetch_product['pname']; ?> &nbsp;&nbsp; <?php echo $fetch_product['pkg']; ?></h5>
      <div class="col-md-4 agileinfo_single_left"> <img id="example" src="life\product_images_upload\<?php echo $fetch_product['pimage']; ?>" alt=" " class="img-responsive"> </div>
      <div class="col-md-8 agileinfo_single_right">
        ...
        <div class="w3agile_description">
          ...
          <br>
          <h4>Specification :</h4>
          <p><?php echo $fetch_product['spec']; ?></p>
        </div>
        <div class="snipcart-item block">
          <div class="snipcart-thumb agileinfo_single_right_snipcart">
            <h4>₹<?php echo $fetch_product['oprice']; ?></h4>
          </div>
	...
	{
		?>
      <h5><?php echo $fetch_product['pname']; ?> &nbsp;&nbsp; <?php echo $fetch_product['pkgs']; ?> <span class="blink_me" style="border:0px solid red; float:right; display:inline-block; color:red; font-weight:900; text-decoration:none;"><?php echo $fetch_product['dis']; ?>% off&nbsp;&nbsp;&nbsp;&nbsp;</span></h5>
      <div class="col-md-4 agileinfo_single_left"> <img id="example" src="life\product_images_upload\<?php echo $fetch_product['pimage']; ?>" alt=" " class="img-responsive"> </div>
      <div class="col-md-8 agileinfo_single_right">
        <div class="rating1"> <span class="starRating">
          <input id="rating5" type="radio" name="rating" value="5">
        ...
        <div class="snipcart-item block">
          <div class="snipcart-thumb agileinfo_single_right_snipcart">
            <h4 style="border:0px solid red; width:100%;">₹<?php echo $fetch_product['oprice']; ?><span>₹<?php echo $fetch_product['price']; ?></span></h4>
          </div>
          <div class="snipcart-details agileinfo_single_right_details">
            <form action="" method="post" >
                      <fieldset>
