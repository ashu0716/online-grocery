...
while($row_slider=mysqli_fetch_array($result_slider))
{
          ...
          <li> <img class="slider-mine" src="life/slider_images_upload/<?php echo $row_slider['simage']; ?>" alt=" " style="width:100%; height:410px;" class="img-responsive" > </li>
          <?php
          }
		  ?>
        </ul>
...
<div class="banner_bottom">
  ...
  <div class="wthree_banner_bottom_left_grid_sub1">-->
    <div class="col-md-4 wthree_banner_bottom_left">
      <div class="wthree_banner_bottom_left_grid" style="margin-left: 35px;"> <img src="images\4.jpg" alt=" " class="img-responsive">
        <div class="wthree_banner_bottom_left_grid_pos">
          <h4>Discount Offer <span>20%</span></h4>
        </div>
      </div>
    </div>
    <div class="col-md-4 wthree_banner_bottom_left">
      <div class="wthree_banner_bottom_left_grid"> <img src="images\5.jpg" alt=" " class="img-responsive">
    ...
    <div class="col-md-4 wthree_banner_bottom_left">
      <div class="wthree_banner_bottom_left_grid"> <img src="images\6.jpg" alt=" " class="img-responsive">
    ...
    <div class="w3l_fresh_vegetables_grids">
      <div class="col-md-3 w3l_fresh_vegetables_grid w3l_fresh_vegetables_grid_left">
        <div class="w3l_fresh_vegetables_grid2">
          <ul>
            <li><i class="fa fa-check" aria-hidden="true"></i><a href="all_brands.php">All Brands</a></li>
            <?php
...
{
?>
            <li><i class="fa fa-check" aria-hidden="true"></i><a href="product_categorys.php?cid=<?php echo $row_category['cid'];?>"><?php echo $row_category['cname'];?></a></li>
            <?php 
  } 
  ?>
          </ul>
          ...
          <div class="w3l_fresh_vegetables_grid1">
            <div class="w3l_fresh_vegetables_grid1_rel"> <img src="images\7.jpg" alt=" " class="img-responsive">
              <div class="w3l_fresh_vegetables_grid1_rel_pos">
                <div class="more m1"> <a href="all_products.php" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a> </div>
              </div>
            </div>
          </div>
