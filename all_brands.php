            ...
            <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
			  ...
			  $cname=$row['cname'];
						$select1="select * from sub_category INNER JOIN category ON category.cid=sub_category.cid where cname='$cname' order by s_cname ";
								$result1=mysqli_query($select1)or die(mysqli_error($conn));
        ...
        <div class="col-md-3 w3ls_w3l_banner_left" style="border:1px solid white; margin-bottom:30px;">
          <div class="hover14 column">
            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid" style="border:1px solid white;" >
              <div class="agile_top_brand_left_grid1"  style="border:1px solid white;"><a  href="brand_products.php?bid=<?php echo $fetch_brand['bid']; ?>"><img style="width:100%; height:180px;" title="" alt="" src="life/brand_images_upload/<?php echo $fetch_brand['bphoto']; ?>"></a> </div>
            </div>
          </div>
        </div>
        <?php
