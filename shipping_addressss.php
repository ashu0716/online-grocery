...
<br>
<?php
			$select_billing_address_select="select * from billing_address INNER JOIN client ON billing_address.clint_id=client.clint_id where clint_uname='$uname' ";
			$query_billing_address_select=mysqli_query($conn,$select_billing_address_select)or die(mysqli_error());
			$row_billing_address_select=mysqli_num_rows($query_billing_address_select);
			
			$fetch_billing_address_select=mysqli_fetch_array($query_billing_address_select);
        ...
        <div class="col-md-12 agileinfo_mail_grid_right" >
          <form  method="post" action="" >
            <h3 > Shipping Address</h3>
              ...
              <input type="text" name="full_name" placeholder="Full Name" value="<?php echo $fetch_billing_address_select['bill_flname']; ?>" >
            </div>
            <div class="col-md-6 wthree_contact_left_grid">
              <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500;" >@-Mail : </p>
              <input type="text" name="email_id" placeholder="@-Mail" value="<?php echo $fetch_billing_address_select['clint_email']; ?>" >
              <p style="margin-top:15px; margin-bottom:15px; font-size:18px; color:#000; font-weight:500;" >Mobile Number : </p>
              <input type="text" name="mobile_no" placeholder="Mobile Number" maxlength="10" value="<?php echo $fetch_billing_address_select['clint_mob']; ?>" >
            </div>
            <div class="col-md-6 wthree_contact_left_grid">
              <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500;" >City : </p>
              <input type="text" name="city" placeholder="City" value="<?php echo $fetch_billing_address_select['bill_city']; ?>" >
              <p style="margin-top:15px; margin-bottom:15px; font-size:18px; color:#000; font-weight:500;" >Pin Code : </p>
              <input type="text" name="pincode" placeholder="Pin Code" maxlength="6" value="<?php echo $fetch_billing_address_select['bill_pincode']; ?>" >
            </div>
            <div class="col-md-12 wthree_contact_left_grid" >
              <p style="margin-top:15px; font-size:18px; color:#000; font-weight:500; " >Address : </p>
            </div>
              <textarea  name="address" placeholder="Address" >
               <?php echo $fetch_billing_address_select['bill_add']; ?>
              </textarea>
            <div class="clearfix"> </div>
            <input type="submit" name="update_update_order" value="Confirm Order">
...
if (isset($_POST['ship_pincode'])) {
  ...
  $pincode = "";
				...
				if(isset($_POST['update_update_order']))
				{
