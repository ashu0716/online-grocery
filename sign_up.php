...
<div class="logo_products">
  <div class="container">
    <div class="w3ls_logo_products_left">
      <h1><a href="index.php"><img style="border:0px solid red;" width="145" height="111" src="life/logo_images_upload/<?php echo $row_logo['limage']; ?>"></a></h1>
    </div>
    <div class="w3ls_logo_products_left1">
      <ul class="special_items">
        <li><a href="all_product.php">Products</a><i>/</i></li>
        <li><a href="about.php">About Us</a><i>/</i></li>
        <li><a href="best_deal.php">Best Deals</a><i>/</i></li>
      ...
      <div class="w3_login_module" >
        <div class="module form-module" >
          ...
          <div class="form"  >
            ...
            <form name="form1" id="form1" action="" method="post"  onsubmit="return validate()">
       <span id="username_reg"  style="width:100%; color: red ; "> </span>
             <input type="text" name="uname_reg" id="uname_reg" placeholder="Username">
              <span id="emailid_reg"  style="width:100%; color: red ; "> </span>
             <input type="text" name="email_reg" id="email_reg" placeholder="Email Address" >
              <span id="password_reg"   style="width:100%; color: red ; "> </span>
             <input type="password" name="pass_reg" id="pass_reg" placeholder="Password" >
              <span id="mobile_reg" style="width:100%; color: red ; "> </span>
             <input type="text" name="mob_reg" id="mob_reg" placeholder="Mobile Number"  maxlength="10" >
...
var ph=document.getElementById("mob_reg").value;


document.getElementById("username_reg").innerText = "";
document.getElementById("emailid_reg").innerText = "";
document.getElementById("password_reg").innerText = "";
document.getElementById("mobile_reg").innerText = "";

if(uname==""&&email==""&&pass==""&&ph=="")
{
	document.getElementById("username_reg").innerText = "Username Required";
	document.getElementById("emailid_reg").innerText = "Email Required";
	document.getElementById("password_reg").innerText = "Password Required";
	document.getElementById("mobile_reg").innerText = "Mobile no. Required";
	return false;
}
else if(email==""&&pass==""&&ph=="")
{
	document.getElementById("emailid_reg").innerText = "Email Required";
	document.getElementById("password_reg").innerText = "Password Required";
	document.getElementById("mobile_reg").innerText = "Mobile no. Required";
...
else if(!isNaN(uname.substr(0,1)))
{
	document.getElementById("username_reg").innerText = "First Letter Character";
	return false;
}
else 
{
...
{
	document.getElementById("emailid_reg").innerText = "Invalid email address format example@mywebsite.com";
 	return false;
}
else 
{
...
else if(isNaN(ph)||ph.indexOf(" ")!=-1)
{
	document.getElementById("mobile_reg").innerText = "Only Numeric Value";
    return false; 
}
else if(ph.length<10)
{
	document.getElementById("mobile_reg").innerText = "Length is small, it should be 10";
	return false;
}
else if(ph.length>10)
{
	document.getElementById("mobile_reg").innerText = "Length is large, it should be 10";
	return false;
}
else 
{
		...
		submit();	
            ...
            $mob_reg=$_POST['mob_reg'];
            $status=$_POST['status'];
					  $insert_reg="insert into client values ('','$uname_reg','$email_reg','$pass_reg','$mob_reg','$status') ";
					  $query_reg=mysqli_query($conn,$insert_reg)or die(mysqli_error());
          ...
          <div class="form">
            ...
            <form action="" method="post">
              ...
              <input type="password" name="pass_log" placeholder="Password" >
          ...
          <?php
				  ...
				  if(isset($_POST['login']))
				  {
						$email_log=$_POST['email_log'];
					  	...
					  	$select_log="select * from client where clint_email='$email_log' and clint_pass='$pass_log' ";
					 	$query_log=mysqli_query($conn,$select_log)or die(mysqli_error());
					 	$num_log=mysqli_num_rows($query_log);
					  
					  if($num_log>0)
					  {
						$select_log_status="select * from client where clint_email='$email_log' and clint_pass='$pass_log' ";
					 	$query_log_status=mysqli_query($conn,$select_log_status)or die(mysqli_error());
					 	$fetch_log_status=mysqli_fetch_array($query_log_status);
						$uname_log=$fetch_log_status['clint_uname'];
					  	$clint_log=$fetch_log_status['clint_id'];
								
						$status_log=$fetch_log_status['clint_status'];
						if($status_log=='Unactive')
							{
								echo "<script> alert(' We Are Extremly Sorry <b>$$uname_log</b>, your account is temporarily deactivated by the admin. !!! '); </script>";
							}	
						else
							{
								session_start();
								$_SESSION['uname']=$uname_log;
								$_SESSION['clint_id']=$clint_log;
...
<div class="newsletter-top-serv-btm">
  <div class="container">
    <div class="col-md-4 wthree_news_top_serv_btm_grid">
      <div class="wthree_news_top_serv_btm_grid_icon"> <i class="fa fa-shopping-cart" aria-hidden="true"></i> </div>
      <h3>Shopping Cart</h3>
      <p>Our website offers a convenient cart service for easy shopping. Add items, proceed to checkout, and enjoy features like quantity updates, item removal, and discounts. Shop quickly and enjoy a streamlined shopping experience.</p>
    </div>
    <div class="col-md-4 wthree_news_top_serv_btm_grid">
      <div class="wthree_news_top_serv_btm_grid_icon"> <i class="fa fa-bar-chart" aria-hidden="true"></i> </div>
      <h3>Purchase Report</h3>
      <p>Our website provides a purchase details service for viewing past orders. Log in and go to purchase history to see past purchases with details such as date, items, and cost. This service makes it easy to keep track of orders. Contact customer support with any questions or concerns.</p>
    </div>
    <div class="col-md-4 wthree_news_top_serv_btm_grid">
      <div class="wthree_news_top_serv_btm_grid_icon"> <i class="fa fa-truck" aria-hidden="true"></i> </div>
      <h3>Shipping Service</h3>
      <p>Our website provides a shipping service that delivers your orders to your doorstep. Choose your shipping options at checkout, including standard or express shipping. Once shipped, you'll receive a tracking number. Our service is fast, reliable, and convenient. If you have any questions, our customer support team is available to assist you.</p>
    </div>
    <div class="clearfix"> </div>
  </div>
</div>
...
<script type="text/javascript">
window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"26612e640c","applicationID":"3365418","transactionName":"NVVXMUVWVkMHBRUPXgwfYBdeGFxVCwkSSVgMVFAdGUdQQA==","queueTime":0,"applicationTime":0,"atts":"GRJURw1MRU0=","errorBeacon":"bam.nr-data.net","agent":""}
