...
<div class="logo_products">
  <div class="container">
    <div class="w3ls_logo_products_left">
      <h1><a href="index.php"><img style="border:0px solid red;width:145px; height:111px;"  src="life/logo_images_upload/<?php echo $row_logo['limage']; ?>"></a></h1>
    </div>
    <div class="w3ls_logo_products_left1">
      <ul class="special_items">
        <li><a href="all_product.php">Products</a> &nbsp; &nbsp; / &nbsp; &nbsp; </li>
        <li><a href="about.php">About Us</a> &nbsp; &nbsp; / &nbsp; &nbsp; </li>
        <li><a href="best_deal.php">Best Deals</a> &nbsp; &nbsp; / &nbsp; &nbsp; </li>
...
<div class="top-brands">
  <div class="container">
    <div class="agile_top_brands_grids" style="border:1px solid red;">
      <h3  style="border:0px solid red; color:#F00;">TERMS AND CONDITIONS</h3>
      <div class="privacy1">
...
<br>
<br>
You should print a copy of these terms and conditions for future reference.</p>
            <div class="privacy2-grid1-sub">
              <h5>1. Information about us</h5>
              <p>We, MS Grocery, a grocery online store and having our registered office at <?php echo $row_shop_details['s_d_add'].", ".$row_shop_details['s_d_street'].", ".$row_shop_details['s_d_city'].", ".$row_shop_details['s_d_state']; ?>.  We operate the website <a href="https://www.<?php echo $row_shop_details['s_d_web']; ?>">www.<?php echo $row_shop_details['s_d_web']; ?></a> (our site).</p>
            </div>
            
            <div class="privacy2-grid1-sub">
              <h5>2. How the contract is formed between you and us</h5>
              <p>2.1 After placing an order, you will receive online notification from us acknowledging that we have received your order. Please note that this does not mean that your order has been accepted. Your order constitutes an offer to us to buy a Product or Service. All orders are subject to acceptance by us. The contract between us (Contract) will only be formed when you receive the Products and/or Services (as applicable).
              <br><br>
...
2.3 In the case of Services, these will be governed by the relevant terms and conditions applicable to the particular service, which will be available on the site to which your service relates – please check these terms and conditions before proceeding with your order.</p>
              
            </div>
            
            <div class="privacy2-grid1-sub">
              <h5>3. Delivery of Products</h5>
              <p>In the case of Products, your order will be fulfilled/made ready for receipt (as applicable) within a reasonable time of the date indicated at the time of ordering, unless there are exceptional circumstances.</p>
            </div>
            
            
            <div class="privacy2-grid1-sub">
              <h5>4. Warranty</h5>
              <p>We warrant to you that any Product purchased from us through our site will, on delivery, conform with its description, be of satisfactory quality, and be reasonably fit for all the purposes for which products of that kind are commonly supplied. All other warranties, conditions or terms relating to fitness for purpose, merchantability, satisfactory quality or condition whether implied by stature or common law are excluded in so far as permitted by law.</p>
            </div>
            
            <div class="privacy2-grid1-sub">
              <h5>5. Cancellation rights</h5>
              <p>5.1 In the case of Products, if you are contracting as a consumer, you have a statutory right to cancel your Product order for any reason and receive a full refund, except in the case of certain products listed in paragraph 5.2. You will receive a full refund of the price paid for the Products (excluding postage costs). Your statutory right to cancel a Contract relating to the purchase of a Product starts from the date when you receive the Product (when the Contract between us is formed). If the Products have been delivered to you, you may cancel at any time within 7 working days, starting from the day after you receive the Products. In the event that you received a Product that is damaged on delivery then please inform us of this in writing as soon as possible. If a Product is returned to us damaged and you have not informed us that the Product was damaged when you received it then we may refuse your right to cancel or receive a refund.
<br>
<br>
...
<br>
<br>
5.4 In the case of Products, to cancel a Contract, you must inform us in writing. If the Products have been delivered to you, you must also return the Products to us as soon as reasonably practicable, and at your own cost. You have a legal obligation to take reasonable care of the Products while they are in your possession.</p>
            </div>
            
            <div class="privacy2-grid1-sub">
              <h5>6. How we use your information</h5>
              <p>Please read the <a href="privacy.php">Privacy Policy</a> for details on how we will use your information. By agreeing and accepting these terms and conditions you hereby agree and accept the terms of our Privacy Policy.</p>
            </div>
            
            <div class="privacy2-grid1-sub">
              <h5>7. Our liability to a consumer</h5>
              <p>7.1 If we fail to comply with these terms and conditions, we are responsible for loss or damage you suffer that is a foreseeable result of our breach of the terms and conditions or our negligence. Loss or damage is foreseeable if it was an obvious consequence of our breach or it was otherwise contemplated by you and us at the time we entered into the relevant Contract.
<br>
<br>
7.2 We only supply the Product and Services for domestic and private use. You agree not to use the product for any commercial, business or re-sale purposes, and we have no liability to you for any loss of profit, loss of business, business interruption, or loss of business opportunity.</p>
            </div>
            
            <div class="privacy2-grid1-sub">
              <h5>8. Our right to vary these terms and conditions</h5>
              <p>8.1 We have the right to revise and amend these terms and conditions from time to time.
<br>
<br>
8.2 You will be subject to the policies and terms and conditions in force at the time that you order Products and/or Services from us, unless any change to those policies or these terms and conditions is required to be made by law or governmental authority (in which case it will apply to orders previously placed by you).</p>
            ...
            <div class="privacy2-grid1-sub">
              <h5>9. Third party rights</h5>
              <p>A person who is not party to these terms and conditions or a Contract shall not have any rights under or in connection with them.</p>
            </div>
            
            <div class="privacy2-grid1-sub">
              <h5>10. Law and jurisdiction</h5>
              <p>These terms and conditions and any dispute or claim arising out of or in connection with them or their subject matter or formation (including non-contractual disputes or claims) will be governed by Indian law. Any dispute or claim arising out of or in connection with these terms and conditions or their formation (including non-contractual disputes or claims) will be subject to the non-exclusive jurisdiction of the courts of India.</p>
            </div>
