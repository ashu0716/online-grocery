      ...
      <div class="agileinfo_mail_grids">
        <div class="col-md-4 agileinfo_mail_grid_left">
          <ul>
            ...
            <li>address <span> <?php echo $row_shop_details['s_d_add']; ?> <br>
              <?php echo $row_shop_details['s_d_street']; ?> <br>
              <?php echo $row_shop_details['s_d_city']; ?> <br>
              <?php echo $row_shop_details['s_d_state']; ?> </span></li>
          </ul>
          <ul>
            <li><i class="fa fa-envelope" aria-hidden="true"></i></li>
            <li>email<span><a href="mailto:<?php echo $row_shop_details['s_d_email']; ?>"><?php echo $row_shop_details['s_d_email']; ?></a></span></li>
          </ul>
          <ul>
            <li><i class="fa fa-phone" aria-hidden="true"></i></li>
            <li>call to us<span> <?php echo $row_shop_details['s_d_ph']; ?></span></li>
          </ul>
        </div>
        <div class="col-md-8 agileinfo_mail_grid_right">
          ...
          <?php
            ...
            $Message=$_POST['Message'];
						...
						$insert_feedback="insert into feedback values ('','$Name','$Email','$Telephone','$Subject','$Message') ";
						$query_feedback=mysqli_query($conn,$insert_feedback) or die(mysqli_error());
						if($query_feedback)
						{
